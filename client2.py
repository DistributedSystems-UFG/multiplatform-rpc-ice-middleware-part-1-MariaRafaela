...
base1 = communicator.stringToProxy("SimplePrinter1:tcp -h 98.94.241.216 -p 11000")
base2 = communicator.stringToProxy("SimplePrinter2:tcp -h 98.94.241.216 -p 11000")
